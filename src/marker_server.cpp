#include <ros/ros.h>
#include <inspection_robot/RoomConnection.h>
#include <inspection_robot/RoomInformation.h>

bool markerCallback(inspection_robot::RoomInformation::Request &req, inspection_robot::RoomInformation::Response &res){
	inspection_robot::RoomConnection conn;
	switch (req.id){
	case 11:
		res.room = "E";
		res.x = 1.5;
...
{
	ros::init(argc, argv, "inspection_robot");
	ros::NodeHandle nh;
